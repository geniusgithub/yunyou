...
public class CRCCheck {
	private static final int[] auchCRCHi = new int[] { 0x00, 0xC1, 0x81, 0x40,
	...
	private final static int TABLE[] = { 0x00000000, 0x04c11db7, 0x09823b6e,
	...
	public static int crc16(byte[] msg, int length) {
		int uchCRCHi = 0x000000FF;
		int uchCRCLo = 0x000000FF;
		int uInDEx = 0;
		int i = 0;
	...
	public static String crc16str(byte[] msg, int length) {
		String check = Integer.toHexString(crc16(msg, length)).toUpperCase();
	...
	public static String crc32str(byte[] msg) {
		String check = Integer.toHexString(crc32(msg)).toUpperCase();
		while (check.length() < 4) {
			check = "0" + check;
		}
		return check;
	...
	public static int crc32(byte[] content) {
		...
		for (int i = 0; i < content.length; i++) {
			crc32 = (crc32 << 8)
					^ TABLE[(reverse(content[i], 8) ^ (crc32 >> 24)) & 0xFF];
		}

		return reverse(crc32 ^ 0xffffffff, 32);
	}

	private static int reverse(int i0, int bits) {
		int i1 = 0;
